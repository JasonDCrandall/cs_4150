...
window = sg.Window('Dashboard PySimpleGUI-Style', layout, margins=(100,100), background_color=BORDER_COLOR, no_titlebar=True, resizable=True, right_click_menu=sg.MENU_RIGHT_CLICK_EDITME_VER_LOC_EXIT)
